...
%             weight_Inv{j}=max(gmin_Inv(j),min(gmax_Inv(j),(1-para.A_pos(j)*para.weight_dec)*weight_Inv{j}+chan_Inv{j}));
            weight{j}=max(gmin_Inv(j),min(gmax_Inv(j),(1-para.A_pos(j)*para.weight_dec)*weight_Inv{j}+chan_Inv{j}));
            weight_Inv{j}=max(gmin(j),min(gmax(j),(1-para.A_pos(j)*para.weight_dec)*weight{j}+chan{j}));
        end;
    end;
